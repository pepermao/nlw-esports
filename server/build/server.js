...
app.get("/games/:id/ads", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return response.json(ads.map(ads => {
        return Object.assign(Object.assign({}, ads), { weekDays: ads.weekDays.split(","), hourStart: (0, convert_minutes_to_hour_string_1.convertMinutesStringToHours)(ads.hourStart), hourEnd: (0, convert_minutes_to_hour_string_1.convertMinutesStringToHours)(ads.hourEnd) });
    }));
}));
